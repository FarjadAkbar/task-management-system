...
const formSchema = z.object({
  ...
  createMeeting: z.boolean().default(true),
  attendees: z
    .array(
      z.object({
...
export function CreateEventDialog({ open, onOpenChange, defaultValues }: CreateEventDialogProps) {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      startTime: defaultValues?.startTime ? format(defaultValues.startTime, "HH:mm") : "09:00",
      endDate: defaultValues?.endTime || new Date(),
      endTime: defaultValues?.endTime ? format(defaultValues.endTime, "HH:mm") : "10:00",
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  ...
                  <div className="space-y-1 leading-none">
                    <FormLabel>Create Google Meet</FormLabel>
                    <FormDescription>Automatically create a Google Meet video conference</FormDescription>
                  </div>
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Add people to invite to this event</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
